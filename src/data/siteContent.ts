...
export const siteContent: SiteContent = {
  ...
  stats: [
    { value: '01', label: 'Metodología clara', detail: 'Técnica, condición y disciplina en cada clase.' },
    { value: '02', label: 'Niveles mixtos', detail: 'Espacio para principiantes, intermedios y competidores.' },
    { value: '03', label: 'Identidad de club', detail: 'Una marca fuerte para comunidad, eventos y contenido.' },
  ],
  story: {
    eyebrow: 'Método',
  ...
  schedule: [
    { day: 'Lunes', hours: '07:00 / 18:00 / 20:00', focus: 'Técnica general y bolsa' },
    { day: 'Miércoles', hours: '07:00 / 18:00 / 20:00', focus: 'Manoplas y desplazamientos' },
    { day: 'Viernes', hours: '07:00 / 19:00', focus: 'Sparring técnico y acondicionamiento' },
    { day: 'Sábado', hours: '10:00', focus: 'Clínica grupal + comunidad' },
  ],
  experience: [
    {
  ...
  footer: {
    copy:
      'Base hecha con React y Tailwind CSS, organizada para que puedas estudiar la estructura, modificar contenido y seguir escalando el proyecto.',
    links: [
      { label: 'Inicio', href: '/#inicio' },
      { label: 'Programas', href: '/#programas' },
      { label: 'Videos', href: '/videos' },
  ...
  videosPage: {
    ...
    title: 'Biblioteca de sesiones para seguir el ritmo del club fuera del gimnasio.',
    description:
      'La mejor estructura es usar YouTube como hosting y descubrimiento, pero guardar en tu app los metadatos de cada video. Así podés filtrar por fecha, categoría y destacar contenido nuevo sin depender de la interfaz de YouTube.',
    helper:
      'Filtro recomendado: por mes de publicación. Es simple para el usuario, escalable y no te obliga a montar backend en esta etapa.',
  },
  trainingVideos: [
    {
    ...
    {
      title: 'Rutina de bolsa para rounds cortos',
      description:
        'Bloques intensos para mejorar volumen, reacción y control del aire en esfuerzos breves.',
